package com.p1ut0nium.animaliumcompat.items;

import com.p1ut0nium.animaliumcompat.Animalium;
import com.p1ut0nium.animaliumcompat.ModItems;
...
public class ItemDogPeltBoots extends ItemArmor {
	...
	public String getArmorTexture(ItemStack is, Entity entity, EntityEquipmentSlot slot, String type) {
		if (is.getItem() == ModItems.DOG_PELT_BOOTS)
			return Constants.MODID + ":textures/items/dog_boots.png";
		else
			return null;
	}
